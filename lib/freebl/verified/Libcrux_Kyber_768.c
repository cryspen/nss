/*
  ...
  ../libcrux_kyber.llbc F* version: d0aa54cf KaRaMeL version: 8e0595bd
 */
...
int32_t
libcrux_kyber_arithmetic_montgomery_multiply_sfe_by_fer(int32_t fe, int32_t fer)
{
  ...
  uint8_t ret[32U])
{
  uint8_t mask = core_num__u8_6__wrapping_sub(
    libcrux_kyber_constant_time_ops_is_non_zero(selector), 1U);
  uint8_t out[32U];
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      size_t i = uu____0.f0;
      uint8_t uu____1 =
        (uint32_t)Eurydice_slice_index(lhs, i, uint8_t) & (uint32_t)mask;
                                                ...
                                                uint16_t coefficient2)
{
  ...
  return (
    (K___uint8_t_uint8_t_uint8_t){ .fst = coef1, .snd = coef2, .thd = coef3 });
}
                                                            ...
                                                            uint8_t ret[384U])
{
  ...
  lit.end = core_slice___Slice_T___len(
              Eurydice_array_to_slice((size_t)256U, re, int32_t), int32_t) /
            (size_t)2U;
  core_ops_range_Range__size_t iter =
    core_iter_traits_collect__I__into_iter(lit, core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter, size_t);
    if (uu____0.tag == core_option_None)
      ...
      K___uint8_t_uint8_t_uint8_t uu____1 =
        libcrux_kyber_serialize_compress_coefficients_3(coefficient1,
                                                        coefficient2);
  ...
  int32_t ret[256U])
{
  ...
  core_ops_range_Range__size_t iter = core_iter_traits_collect__I__into_iter(
    ((core_ops_range_Range__size_t){
      .start = (size_t)0U,
      .end = core_slice___Slice_T___len(serialized, uint8_t) / (size_t)3U }),
    core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter, size_t);
    if (uu____0.tag == core_option_None)
      ...
      int32_t byte2 = (int32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t);
      int32_t byte3 = (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t);
  ...
  int32_t ret[256U])
{
  ...
  core_ops_range_Range__size_t iter0 = core_iter_traits_collect__I__into_iter(
    ((core_ops_range_Range__size_t){
      .start = (size_t)0U,
      .end = core_slice___Slice_T___len(randomness, uint8_t) / (size_t)4U }),
    core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
    ...
    if (uu____0.tag == core_option_None)
      ...
      uint32_t uu____2 =
        uu____1 |
        (uint32_t)Eurydice_slice_index(byte_chunk, (size_t)1U, uint8_t) << 8U;
      uint32_t uu____3 =
        uu____2 |
        (uint32_t)Eurydice_slice_index(byte_chunk, (size_t)2U, uint8_t) << 16U;
      uint32_t random_bits_as_u32 =
        uu____3 |
        (uint32_t)Eurydice_slice_index(byte_chunk, (size_t)3U, uint8_t) << 24U;
      ...
      while (true) {
        core_option_Option__uint32_t uu____4 =
          core_iter_range__core__ops__range__Range_A__3__next(&iter, uint32_t);
  ...
  int32_t ret[256U])
{
  ...
  core_ops_range_Range__size_t iter0 = core_iter_traits_collect__I__into_iter(
    ((core_ops_range_Range__size_t){
      .start = (size_t)0U,
      .end = core_slice___Slice_T___len(randomness, uint8_t) / (size_t)3U }),
    core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter0, size_t);
    if (uu____0.tag == core_option_None)
      ...
      while (true) {
        core_option_Option__int32_t uu____3 =
          core_iter_range__core__ops__range__Range_A__3__next(&iter, int32_t);
...
const int32_t libcrux_kyber_ntt_ZETAS_TIMES_MONTGOMERY_R[128U] = {
    ...
    if (uu____0.tag == core_option_None)
      ...
      while (true) {
        ...
        if (uu____1.tag == core_option_None)
          ...
          size_t j = uu____1.f0;
          int32_t t = libcrux_kyber_arithmetic_montgomery_multiply_sfe_by_fer(
            re[j + step],
  ...
  int32_t ret[256U])
{
  ...
  core_slice_iter_Chunks iter = core_iter_traits_collect__I__into_iter(
    core_slice___Slice_T___chunks(
      Eurydice_array_to_slice((size_t)840U, randomness, uint8_t),
      (size_t)3U,
      uint8_t),
    core_slice_iter_Chunks);
  while (true) {
    core_option_Option__Eurydice_slice_uint8_t uu____0 =
      core_slice_iter__core__slice__iter__Chunks__a__T__70__next(&iter,
                                                                 uint8_t);
    if (uu____0.tag == core_option_None)
      break;
    else {
                                         ...
                                         int32_t zeta)
{
  ...
  int32_t uu____1 = libcrux_kyber_arithmetic_montgomery_reduce(
    uu____0 + libcrux_kyber_arithmetic_montgomery_reduce(a1 * b1) * zeta);
  return ((K___int32_t_int32_t){
    .fst = uu____1,
                               ...
                               int32_t ret[256U])
{
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      K___int32_t_int32_t product = libcrux_kyber_ntt_ntt_multiply_binomials(
        lit0,
        lit1,
      ...
      K___int32_t_int32_t product0 = libcrux_kyber_ntt_ntt_multiply_binomials(
        lit2,
        lit,
        -libcrux_kyber_ntt_ZETAS_TIMES_MONTGOMERY_R[(size_t)64U + i]);
                                                 ...
                                                 int32_t coefficient4)
{
  ...
  return ((K___uint8_t_uint8_t_uint8_t_uint8_t_uint8_t){
    ...
    if (uu____0.tag == core_option_None)
      ...
      while (true) {
        ...
        if (uu____1.tag == core_option_None)
          ...
          re[j] = re[j] + re[j + step];
          int32_t uu____2 = libcrux_kyber_arithmetic_montgomery_reduce(
            a_minus_b * libcrux_kyber_ntt_ZETAS_TIMES_MONTGOMERY_R[zeta_i[0U]]);
          re[j + step] = uu____2;
        }
      }
    }
  ...
  int32_t ret[256U])
{
  ...
  lit.start = (size_t)0U;
  lit.end = core_slice___Slice_T___len(
    Eurydice_array_to_slice((size_t)32U, serialized, uint8_t), uint8_t);
  core_ops_range_Range__size_t iter0 =
    core_iter_traits_collect__I__into_iter(lit, core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
                                                   ...
                                                   int32_t byte5)
{
  ...
  return ((K___int32_t_int32_t_int32_t_int32_t){ .fst = coefficient1,
                                                 .snd = coefficient2,
                                                 .thd = coefficient3,
                                                 .f3 = coefficient4 });
}
  ...
  int32_t ret[256U])
{
  ...
  core_ops_range_Range__size_t iter = core_iter_traits_collect__I__into_iter(
    ((core_ops_range_Range__size_t){
      .start = (size_t)0U,
      .end = core_slice___Slice_T___len(serialized, uint8_t) / (size_t)5U }),
    core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter, size_t);
    if (uu____0.tag == core_option_None)
      ...
      int32_t byte2 = (int32_t)Eurydice_slice_index(bytes, (size_t)1U, uint8_t);
      int32_t byte3 = (int32_t)Eurydice_slice_index(bytes, (size_t)2U, uint8_t);
      int32_t byte4 = (int32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t);
      int32_t byte5 = (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t);
      K___int32_t_int32_t_int32_t_int32_t uu____1 =
        libcrux_kyber_serialize_decompress_coefficients_10(
          byte2, byte1, byte3, byte4, byte5);
      ...
      int32_t uu____2 =
        libcrux_kyber_compress_decompress_ciphertext_coefficient(10U,
                                                                 coefficient1);
                                                   ...
                                                   int32_t byte11)
{
  ...
  return ((K___int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t){
    .fst = coefficient1,
    .snd = coefficient2,
    .thd = coefficient3,
    .f3 = coefficient4,
  ...
  int32_t ret[256U])
{
  ...
  core_ops_range_Range__size_t iter = core_iter_traits_collect__I__into_iter(
    ((core_ops_range_Range__size_t){
      .start = (size_t)0U,
      .end = core_slice___Slice_T___len(serialized, uint8_t) / (size_t)11U }),
    core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter, size_t);
    if (uu____0.tag == core_option_None)
      ...
      int32_t byte4 = (int32_t)Eurydice_slice_index(bytes, (size_t)3U, uint8_t);
      int32_t byte5 = (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t);
      int32_t byte6 = (int32_t)Eurydice_slice_index(bytes, (size_t)5U, uint8_t);
      int32_t byte7 = (int32_t)Eurydice_slice_index(bytes, (size_t)6U, uint8_t);
      int32_t byte8 = (int32_t)Eurydice_slice_index(bytes, (size_t)7U, uint8_t);
      int32_t byte9 = (int32_t)Eurydice_slice_index(bytes, (size_t)8U, uint8_t);
      int32_t byte10 =
        (int32_t)Eurydice_slice_index(bytes, (size_t)9U, uint8_t);
      int32_t byte11 =
        (int32_t)Eurydice_slice_index(bytes, (size_t)10U, uint8_t);
      K___int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t
        uu____1 = libcrux_kyber_serialize_decompress_coefficients_11(byte2,
                                                                     byte1,
                                                                     byte3,
                                                                     byte5,
                                                                     byte4,
      ...
      int32_t uu____2 =
        libcrux_kyber_compress_decompress_ciphertext_coefficient(11U,
                                                                 coefficient1);
                                                      ...
                                                      int32_t ret[256U])
{
  ...
  core_ops_range_Range__size_t iter = core_iter_traits_collect__I__into_iter(
    ((core_ops_range_Range__size_t){
      .start = (size_t)0U,
      .end = core_slice___Slice_T___len(serialized, uint8_t) }),
    core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter, size_t);
    if (uu____0.tag == core_option_None)
      ...
      size_t i = uu____0.f0;
      uint8_t* byte = &Eurydice_slice_index(serialized, i, uint8_t);
      K___int32_t_int32_t uu____1 =
        libcrux_kyber_serialize_decompress_coefficients_4(byte);
      int32_t coefficient1 = uu____1.fst;
      int32_t coefficient2 = uu____1.snd;
      int32_t uu____2 =
        libcrux_kyber_compress_decompress_ciphertext_coefficient(4U,
                                                                 coefficient1);
                                                      ...
                                                      int32_t ret[256U])
{
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      int32_t byte5 = (int32_t)Eurydice_slice_index(bytes, (size_t)4U, uint8_t);
      K___int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t_int32_t
        uu____1 = libcrux_kyber_serialize_decompress_coefficients_5(
      ...
      int32_t coefficient8 = uu____1.f7;
      int32_t uu____2 =
        libcrux_kyber_compress_decompress_ciphertext_coefficient(5U,
                                                                 coefficient1);
      re[(size_t)8U * i] = uu____2;
      int32_t uu____3 =
        libcrux_kyber_compress_decompress_ciphertext_coefficient(5U,
    ...
    if (uu____0.tag == core_option_None)
      ...
      core_ops_range_Range__size_t iter =
        core_iter_traits_collect__I__into_iter(
          ((core_ops_range_Range__size_t){
            .start = (size_t)0U,
            .end = core_slice___Slice_T___len(coefficients, int32_t) }),
          core_ops_range_Range__size_t);
      while (true) {
        core_option_Option__size_t uu____1 =
          core_iter_range__core__ops__range__Range_A__3__next(&iter, size_t);
        if (uu____1.tag == core_option_None)
          ...
          size_t j = uu____1.f0;
          int32_t* coefficient =
            &Eurydice_slice_index(coefficients, j, int32_t);
          uint16_t coefficient0 =
            libcrux_kyber_arithmetic_to_unsigned_representative(
              coefficient[0U]);
          uint8_t coefficient_compressed =
            libcrux_kyber_compress_compress_message_coefficient(coefficient0);
          size_t uu____2 = i;
    ...
    if (uu____0.tag == core_option_None)
      ...
      while (true) {
        ...
        if (uu____4.tag == core_option_None)
          ...
          int32_t sampled[256U];
          libcrux_kyber_sampling_sample_from_uniform_distribution(uu____5,
                                                                  sampled);
          if (transpose)
                                                   ...
                                                   uint8_t ret[34U])
{
  ...
  core_slice___Slice_T___copy_from_slice(
    Eurydice_array_to_subslice(
      ...
      ((core_ops_range_Range__size_t){
        .start = (size_t)0U,
        .end = core_slice___Slice_T___len(slice, uint8_t) }),
      uint8_t,
      core_ops_range_Range__size_t),
    slice,
    uint8_t);
  ...
  uint8_t domain_separator)
{
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      libcrux_kyber_hash_functions_PRF___128size_t(
        Eurydice_array_to_slice((size_t)33U, prf_input, uint8_t), prf_output);
      int32_t r[256U];
      libcrux_kyber_sampling_sample_from_binomial_distribution___2size_t(
        Eurydice_array_to_slice((size_t)128U, prf_output, uint8_t), r);
                                                       ...
                                                       int32_t ret[256U])
{
  ...
  lit.start = (size_t)0U;
  lit.end = core_slice___Slice_T___len(
    Eurydice_array_to_slice((size_t)256U, lhs, int32_t), int32_t);
  core_ops_range_Range__size_t iter =
    core_iter_traits_collect__I__into_iter(lit, core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
                                                 ...
                                                 int32_t ret[3U][256U])
{
  ...
  lit0.end = core_slice___Slice_T___len(
    Eurydice_array_to_slice((size_t)3U, matrix_A, Eurydice_error_t_cg_array),
    int32_t[3U][256U]);
  core_ops_range_Range__size_t iter =
    core_iter_traits_collect__I__into_iter(lit0, core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
      core_iter_range__core__ops__range__Range_A__3__next(&iter, size_t);
    if (uu____0.tag == core_option_None)
      ...
      while (true) {
        ...
        if (uu____3.tag == core_option_None)
          ...
          int32_t coefficient_normal_form =
            libcrux_kyber_arithmetic_to_standard_domain(result[i][j]);
          int32_t uu____4 = libcrux_kyber_arithmetic_barrett_reduce(
            coefficient_normal_form + error_as_ntt[i][j]);
          result[i][j] = uu____4;
        }
      }
    }
  ...
  uint8_t ret[1152U])
{
  ...
  lit.start = (size_t)0U;
  lit.end = core_slice___Slice_T___len(
    Eurydice_array_to_slice((size_t)3U, key, int32_t[256U]), int32_t[256U]);
  core_ops_range_Range__size_t iter =
    core_iter_traits_collect__I__into_iter(lit, core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
    ...
    if (uu____0.tag == core_option_None)
      ...
      core_slice___Slice_T___copy_from_slice(
        uu____1, Eurydice_array_to_slice((size_t)384U, ret0, uint8_t), uint8_t);
    }
  }
  ...
  uint8_t ret[1184U])
{
  ...
  uint8_t ret0[1152U];
  libcrux_kyber_ind_cpa_serialize_secret_key___3size_t_1152size_t(uu____1,
                                                                  ret0);
  core_slice___Slice_T___copy_from_slice(
    uu____0, Eurydice_array_to_slice((size_t)1152U, ret0, uint8_t), uint8_t);
  core_slice___Slice_T___copy_from_slice(
    Eurydice_array_to_subslice_from(
      (size_t)1184U, public_key_serialized, (size_t)1152U, uint8_t, size_t),
    seed_for_a,
    uint8_t);
  ...
  Eurydice_slice key_generation_seed)
{
  ...
  uint8_t prf_input[33U];
  libcrux_kyber_ind_cpa_into_padded_array___33size_t(seed_for_secret_and_error,
                                                     prf_input);
  uint8_t uu____1[33U];
  memcpy(uu____1, prf_input, (size_t)33U * sizeof(uint8_t));
  K___libcrux_kyber_arithmetic_PolynomialRingElement_3size_t__uint8_t uu____2 =
    libcrux_kyber_ind_cpa_sample_vector_cbd_then_ntt___3size_t_2size_t_128size_t(
      uu____1, 0U);
  ...
  uint8_t ret[2400U])
{
  ...
  core_slice___Slice_T___copy_from_slice(
    Eurydice_array_to_subslice(
      ...
      ((core_ops_range_Range__size_t){
        .start = uu____1,
        .end = uu____2 + core_slice___Slice_T___len(private_key, uint8_t) }),
      uint8_t,
      core_ops_range_Range__size_t),
    private_key,
    uint8_t);
  ...
  core_slice___Slice_T___copy_from_slice(
    Eurydice_array_to_subslice(
      ...
      ((core_ops_range_Range__size_t){
        .start = uu____4,
        .end = uu____5 + core_slice___Slice_T___len(public_key, uint8_t) }),
      uint8_t,
      core_ops_range_Range__size_t),
    public_key,
    uint8_t);
  ...
  core_slice___Slice_T___copy_from_slice(
    Eurydice_array_to_subslice(
      ...
      ((core_ops_range_Range__size_t){
        .start = uu____8,
        .end = uu____9 +
               core_slice___Slice_T___len(implicit_rejection_value, uint8_t) }),
      uint8_t,
      core_ops_range_Range__size_t),
  ...
  uint8_t randomness[64U])
{
  ...
  return libcrux_kyber_types__libcrux_kyber__types__KyberKeyPair_PRIVATE_KEY_SIZE__PUBLIC_KEY_SIZE___from___2400size_t_1184size_t(
    uu____3, uu____4);
}
...
libcrux_kyber_kyber768_generate_key_pair_768(uint8_t randomness[64U])
{
  ...
  return libcrux_kyber_generate_keypair___3size_t_1152size_t_2400size_t_1184size_t_1152size_t_2size_t_128size_t(
    uu____0);
}
  ...
  int32_t ret[3U][256U])
{
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      int32_t uu____1[256U];
      libcrux_kyber_sampling_sample_from_binomial_distribution___2size_t(
        Eurydice_array_to_slice((size_t)128U, prf_output, uint8_t), uu____1);
                                                ...
                                                int32_t ret[3U][256U])
{
  ...
  lit0.start = (size_t)0U;
  lit0.end = core_slice___Slice_T___len(
    Eurydice_array_to_slice((size_t)3U, a_as_ntt, Eurydice_error_t_cg_array),
    int32_t[3U][256U]);
  core_ops_range_Range__size_t iter =
    core_iter_traits_collect__I__into_iter(lit0, core_ops_range_Range__size_t);
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      while (true) {
        ...
        if (uu____4.tag == core_option_None)
          ...
          size_t j = uu____4.f0;
          int32_t coefficient_normal_form =
            libcrux_kyber_arithmetic_montgomery_reduce(result[i][j] *
                                                       (int32_t)1441);
          int32_t uu____5 = libcrux_kyber_arithmetic_barrett_reduce(
            coefficient_normal_form + error_1[i][j]);
          result[i][j] = uu____5;
        }
      }
    }
  ...
  while (true) {
    ...
    if (uu____1.tag == core_option_None)
      ...
      int32_t uu____2 = libcrux_kyber_arithmetic_barrett_reduce(
        coefficient_normal_form + error_2[0U][i] + message[0U][i]);
      result[i] = uu____2;
    }
  }
    ...
    if (uu____0.tag == core_option_None)
      ...
      int32_t coefficient3 =
        libcrux_kyber_compress_compress_ciphertext_coefficient(
          10U,
          libcrux_kyber_arithmetic_to_unsigned_representative(
            Eurydice_slice_index(coefficients, (size_t)2U, int32_t)));
      int32_t coefficient4 =
        libcrux_kyber_compress_compress_ciphertext_coefficient(
          10U,
          libcrux_kyber_arithmetic_to_unsigned_representative(
            Eurydice_slice_index(coefficients, (size_t)3U, int32_t)));
      K___uint8_t_uint8_t_uint8_t_uint8_t_uint8_t uu____1 =
    ...
    if (uu____0.tag == core_option_None)
      ...
      int32_t coefficient5 =
        libcrux_kyber_compress_compress_ciphertext_coefficient(
          11U,
          libcrux_kyber_arithmetic_to_unsigned_representative(
            Eurydice_slice_index(coefficients, (size_t)4U, int32_t)));
      int32_t coefficient6 =
        libcrux_kyber_compress_compress_ciphertext_coefficient(
          11U,
          libcrux_kyber_arithmetic_to_unsigned_representative(
            Eurydice_slice_index(coefficients, (size_t)5U, int32_t)));
      int32_t coefficient7 =
        libcrux_kyber_compress_compress_ciphertext_coefficient(
          11U,
          libcrux_kyber_arithmetic_to_unsigned_representative(
            Eurydice_slice_index(coefficients, (size_t)6U, int32_t)));
      int32_t coefficient8 =
        libcrux_kyber_compress_compress_ciphertext_coefficient(
          11U,
          libcrux_kyber_arithmetic_to_unsigned_representative(
            Eurydice_slice_index(coefficients, (size_t)7U, int32_t)));
      K___uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t_uint8_t
        uu____1 =
  ...
  uint8_t ret[960U])
{
  ...
  lit.start = (size_t)0U;
  lit.end = core_slice___Slice_T___len(
    Eurydice_array_to_slice((size_t)3U, input, int32_t[256U]), int32_t[256U]);
  core_ops_range_Range__size_t iter =
    core_iter_traits_collect__I__into_iter(lit, core_ops_range_Range__size_t);
  while (true) {
    core_option_Option__size_t uu____0 =
    ...
    if (uu____0.tag == core_option_None)
      ...
      libcrux_kyber_serialize_compress_then_serialize_ring_element_u___10size_t_320size_t(
        re, ret0);
      core_slice___Slice_T___copy_from_slice(
        uu____1, Eurydice_array_to_slice((size_t)320U, ret0, uint8_t), uint8_t);
    }
  }
...
void
libcrux_kyber_serialize_compress_then_serialize_4___128size_t(int32_t re[256U],
                                                              uint8_t ret[128U])
{
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      Eurydice_slice coefficients = Eurydice_array_to_subslice(
        ...
        core_ops_range_Range__size_t);
      uint8_t coefficient1 =
        (uint8_t)libcrux_kyber_compress_compress_ciphertext_coefficient(
          4U,
          libcrux_kyber_arithmetic_to_unsigned_representative(
            Eurydice_slice_index(coefficients, (size_t)0U, int32_t)));
...
void
libcrux_kyber_serialize_compress_then_serialize_5___128size_t(int32_t re[256U],
                                                              uint8_t ret[128U])
{
  uint8_t serialized[128U];
  for (size_t i = (size_t)0U; i < (size_t)128U; i++)
...
{
  int32_t t_as_ntt[3U][256U];
  libcrux_kyber_ind_cpa_deserialize_public_key___3size_t_1152size_t(public_key,
                                                                    t_as_ntt);
  Eurydice_slice seed =
  ...
  libcrux_kyber_matrix_sample_matrix_A___3size_t(ret0, false, A_transpose);
  uint8_t prf_input[33U];
  ...
  K___libcrux_kyber_arithmetic_PolynomialRingElement_3size_t__uint8_t uu____1 =
    libcrux_kyber_ind_cpa_sample_vector_cbd_then_ntt___3size_t_2size_t_128size_t(
      uu____0, 0U);
  ...
  int32_t error_2[256U];
  libcrux_kyber_sampling_sample_from_binomial_distribution___2size_t(
    Eurydice_array_to_slice((size_t)128U, prf_output, uint8_t), error_2);
  int32_t u[3U][256U];
  ...
  libcrux_kyber_serialize_deserialize_then_decompress_message(
    uu____2, message_as_ring_element);
  int32_t v[256U];
  ...
  libcrux_kyber_ind_cpa_into_padded_array___1088size_t(
    Eurydice_array_to_slice((size_t)960U, c1, uint8_t), ciphertext);
  Eurydice_slice uu____4 = Eurydice_array_to_subslice_from(
    (size_t)1088U, ciphertext, (size_t)960U, uint8_t, size_t);
  core_slice___Slice_T___copy_from_slice(
    uu____4,
  ...
  uint8_t randomness[32U])
{
  ...
  Eurydice_slice_to_array2(&dst, shared_secret0, Eurydice_slice, uint8_t[32U]);
  core_result_Result__uint8_t_32size_t__core_array_TryFromSliceError uu____4 =
    dst;
  ...
  memcpy(shared_secret1, uu____4.val.case_Ok, (size_t)32U * sizeof(uint8_t));
  uint8_t shared_secret[32U];
  memcpy(shared_secret, shared_secret1, (size_t)32U * sizeof(uint8_t));
  uint8_t uu____5[1088U];
  memcpy(uu____5, ciphertext, (size_t)1088U * sizeof(uint8_t));
  uint8_t uu____6[1088U];
  memcpy(uu____6, uu____5, (size_t)1088U * sizeof(uint8_t));
  uint8_t uu____7[32U];
  memcpy(uu____7, shared_secret, (size_t)32U * sizeof(uint8_t));
  K___libcrux_kyber_types_KyberCiphertext__1088size_t___uint8_t_32size_t_ lit;
  memcpy(lit.fst, uu____6, (size_t)1088U * sizeof(uint8_t));
  memcpy(lit.snd, uu____7, (size_t)32U * sizeof(uint8_t));
  return lit;
}
                                       ...
                                       uint8_t randomness[32U])
{
  ...
  return libcrux_kyber_encapsulate___3size_t_1088size_t_1184size_t_1152size_t_960size_t_128size_t_10size_t_4size_t_320size_t_2size_t_128size_t_2size_t_128size_t(
    uu____0, uu____1);
}
  ...
  uint8_t ret[32U])
{
  ...
  libcrux_kyber_serialize_deserialize_then_decompress_ring_element_v___4size_t(
    ...
    v);
  int32_t secret_as_ntt[3U][256U];
  libcrux_kyber_ind_cpa_deserialize_secret_key___3size_t(secret_key,
                                                         secret_as_ntt);
  int32_t message[256U];
  libcrux_kyber_matrix_compute_message___3size_t(
    &v, secret_as_ntt, u_as_ntt, message);
  uint8_t ret0[32U];
  ...
  Eurydice_slice rhs)
{
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      r = (uint32_t)r |
          ((uint32_t)uu____1 ^ (uint32_t)Eurydice_slice_index(rhs, i, uint8_t));
    }
  }
  ...
  uint8_t ret[32U])
{
  K___Eurydice_slice_uint8_t_Eurydice_slice_uint8_t uu____0 =
    libcrux_kyber_types__libcrux_kyber__types__KyberPrivateKey_SIZE__12__split_at___2400size_t(
      secret_key, (size_t)1152U);
  Eurydice_slice ind_cpa_secret_key = uu____0.fst;
  Eurydice_slice secret_key0 = uu____0.snd;
  K___Eurydice_slice_uint8_t_Eurydice_slice_uint8_t uu____1 =
    core_slice___Slice_T___split_at(secret_key0, (size_t)1184U, uint8_t);
  ...
  libcrux_kyber_ind_cpa_into_padded_array___1120size_t(implicit_rejection_value,
                                                       to_hash);
  Eurydice_slice uu____4 =
  ...
  libcrux_kyber_hash_functions_PRF___32size_t(
  ...
  libcrux_kyber_constant_time_ops_select_shared_secret_in_constant_time(
    uu____8,
    Eurydice_array_to_slice(
      (size_t)32U, implicit_rejection_shared_secret, uint8_t),
    selector,
    ret0);
  memcpy(ret, ret0, (size_t)32U * sizeof(uint8_t));
}
