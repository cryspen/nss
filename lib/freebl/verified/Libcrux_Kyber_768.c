/*
  ...
  ../libcrux_kyber.llbc F* version: d0aa54cf KaRaMeL version: 11522064
 */
...
typedef struct Range__uint32_t_s
{
  uint32_t start;
  uint32_t end;
} Range__uint32_t;
  ...
  int32_t ret[256U])
{
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      Range__uint32_t iter = core_iter_traits_collect__I__into_iter(
        ((Range__uint32_t){ .start = 0U, .end = core_num__u32_8__BITS / 4U }),
        Range__uint32_t,
        Range__uint32_t);
      while (true) {
...
typedef struct Range__int32_t_s
{
  int32_t start;
  int32_t end;
} Range__int32_t;
  ...
  int32_t ret[256U])
{
  ...
  while (true) {
    ...
    if (uu____0.tag == core_option_None)
      ...
      Range__int32_t iter = core_iter_traits_collect__I__into_iter(
        ((Range__int32_t){ .start = (int32_t)0,
...
typedef struct Option__Eurydice_slice_uint8_t_s
{
  core_option_Option__size_t_tags tag;
  Eurydice_slice f0;
} Option__Eurydice_slice_uint8_t;
  ...
  core_slice_iter_Chunks iter = core_iter_traits_collect__I__into_iter(
    core_slice___Slice_T___chunks(
      Eurydice_array_to_slice(
        (size_t)840U, randomness, uint8_t, Eurydice_slice),
      (size_t)3U,
      uint8_t,
    ...
    core_slice_iter_Chunks);
  while (true) {
    Option__Eurydice_slice_uint8_t uu____0 =
  ...
  if (uu____0) {
    ...
    __uint8_t_840size_t__uint8_t_840size_t__uint8_t_840size_t__uint8_t_840size_t_
      uu____6 = libcrux_digest_shake128x4(
        ...
        uu____5,
        Eurydice_array_to_slice(
          (size_t)34U, input[0U], uint8_t, Eurydice_slice),
        __uint8_t_840size_t__uint8_t_840size_t__uint8_t_840size_t__uint8_t_840size_t_);
    uint8_t d0[840U];
  ...
  uint8_t randomness[32U])
{
  ...
  Eurydice_slice_to_array2(
    &dst, shared_secret0, Eurydice_slice, uint8_t[32U], void*);
  Result__uint8_t_32size_t__core_array_TryFromSliceError uu____4 = dst;
  if (!(uu____4.tag == Ok)) {
    KRML_HOST_EPRINTF(
      "KaRaMeL abort at %s:%d\n%s\n", __FILE__, __LINE__, "panic!");
    KRML_HOST_EXIT(255U);
